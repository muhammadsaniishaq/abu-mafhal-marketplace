...
import { PAYMENT_OPTIONS } from './flw_configs';
...
PayWithFlutterwave.propTypes = __assign(__assign({}, PayWithFlutterwavePropTypesBase), {
    // @ts-ignore
    options: PropTypes.shape(__assign(__assign({}, OptionsPropTypeBase), {
        authorization: PropTypes.string.isRequired, tx_ref: PropTypes.string.isRequired, payment_options: PaymentOptionsPropRule(PAYMENT_OPTIONS), customer: PropTypes.shape({
