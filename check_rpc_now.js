...
async function check() {
    const { error } = await supabase.rpc('confirm_order_receipt', { p_order_id: '00000000-0000-0000-0000-000000000000' });
    console.log('Result for confirm_order_receipt:', error ? error.message : 'Exists (dummy call successful)');
}
check();
